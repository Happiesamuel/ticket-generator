      ...
      >
        ...
        <g filter="url(#filter0_d_11_797)">
          <rect
            ...
            fill="#D9D9D9"
          />
          <image href="/svg.jpg" x="30" y="30" width="100" height="100" />
        ...
        {/* <!-- Background --> */}
        {/* <rect width="750" height="250" rx="20" fill="#0E464F" /> */}

        {/* <!-- Left QR Code Box --> */}
        {/* <rect x="20" y="20" width="120" height="120" rx="10" fill="white" /> */}
        ...
        <text x="150" y="70" font-family="Arial" font-size="18" fill="white">
          📍 04 Rumens road, Ikoyi, Lagos
        </text>
        <text x="150" y="120" font-family="Arial" font-size="18" fill="white">
          📅 March 15, 2025 | 7:00 PM
        </text>

        {/* <!-- VIP Badge --> */}
        <polygon points="500,20 550,10 560,30 530,50 510,40" fill="white" />
        <text
          x="515"
          y="35"
          font-family="Arial"
        ...
        {/* <!-- Right VIP Section --> */}
        <rect x="600" y="20" width="130" height="210" rx="10" fill="black" />
        <text
          x="610"
          y="60"
          font-family="Arial"
        ...
        {/* <!-- Ticket Disclaimer --> */}
        <text x="50" y="220" font-family="Arial" font-size="14" fill="white">
...
<div className="relative">
  <img
    src="/svg.jpg"
    className="w-[122px] h-[120px] absolute bottom-[34px] left-[10px] rounded-md"
  />
</div>
</div> */
}
